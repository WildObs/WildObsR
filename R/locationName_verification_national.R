...
#Assign area_name 
    ...
    gdb_data = layer_data
      ...
      dep_sp <- vect(dep , geom = c(lon_col, lat_col), "EPSG:4326")  # crs_info is the projection you want to use (e.g. "EPSG:4326")
      
      dep_sp <- project(dep_sp,crs_info)
      
      # Check the extents again to confirm they align
      print(ext(dep_sp))
      print(ext(gdb_data))
